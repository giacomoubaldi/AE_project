	soc_system u0 (
		...
		.hps_fpga_ram_sync_gp_in                (<connected-to-hps_fpga_ram_sync_gp_in>),                //               hps_fpga_ram_sync.gp_in
		.hps_fpga_ram_sync_gp_out               (<connected-to-hps_fpga_ram_sync_gp_out>),               //                                .gp_out
		.iofifo_datain                          (<connected-to-iofifo_datain>),                          //                          iofifo.datain
		.iofifo_writereq                        (<connected-to-iofifo_writereq>),                        //                                .writereq
		.iofifo_instatus                        (<connected-to-iofifo_instatus>),                        //                                .instatus
		.iofifo_dataout                         (<connected-to-iofifo_dataout>),                         //                                .dataout
		.iofifo_readack                         (<connected-to-iofifo_readack>),                         //                                .readack
		.iofifo_outstatus                       (<connected-to-iofifo_outstatus>),                       //                                .outstatus
		.iofifo_regdataout                      (<connected-to-iofifo_regdataout>),                      //                                .regdataout
		.iofifo_regreadack                      (<connected-to-iofifo_regreadack>),                      //                                .regreadack
		.iofifo_regoutstatus                    (<connected-to-iofifo_regoutstatus>),                    //                                .regoutstatus
		...
		.to_ram_ctrl_fpga_side_reg              (<connected-to-to_ram_ctrl_fpga_side_reg>),              //                     to_ram_ctrl.fpga_side_reg
		.to_ram_ctrl_hps_side_reg               (<connected-to-to_ram_ctrl_hps_side_reg>),               //                                .hps_side_reg
		.to_ram_ctrl_enable                     (<connected-to-to_ram_ctrl_enable>),                     //                                .enable
		.to_ram_fifo_data_ack                   (<connected-to-to_ram_fifo_data_ack>),                   //                     to_ram_fifo.data_ack
		.to_ram_fifo_data_event                 (<connected-to-to_ram_fifo_data_event>),                 //                                .data_event
		.to_ram_fifo_data_empty                 (<connected-to-to_ram_fifo_data_empty>),                 //                                .data_empty
		.version_pio_external_connection_export (<connected-to-version_pio_external_connection_export>)  // version_pio_external_connection.export
	);
